...
procedure ExceptionLocacaoVeiculoAlugado;
begin
 raise TExceptionLocacaoVeiculoAlugado.Create('Veículo já consta alugado');
end;
...
procedure ExceptionMinimoPlacaVeiculo;
begin
   raise TExceptionMinimoPlacaVeiculo.Create('Placa deve conter no mínimo 7 caracteres ');
end;
...
procedure ExceptionMinimoDocumento;
begin
  raise TExceptionMinimoDocumento.Create('Documento deve conter no minímo 4 caracteres');
end;
...
procedure ExceptionMinimoNome;
begin
  raise TexceptionMinimoNome.Create('Nome deve conter no minímo 4 caracteres');
end;
